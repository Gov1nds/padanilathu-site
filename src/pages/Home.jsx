      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.06] shadow-2xl backdrop-blur-xl">
        ...
        <div className="relative p-7 sm:p-10">
          ...
          <p className="mt-5 max-w-xl text-sm leading-relaxed text-white/70 hero-anim-3">
            Our expertise lies in premium outdoor and landscape development, integrating sustainable design, green architectural principles, and quality execution to create resilient, eco-conscious environmentsF
          </p>
